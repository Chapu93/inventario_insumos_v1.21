...
try {
    ...
    $data = array_map(function($r){
        ...
        $acciones = '<div class="btn-group" role="group">'
                  . '<button type="button" class="btn btn-sm btn-info" onclick="verInsumo(' . (int)$r['id_insumo'] . ')" data-bs-toggle="tooltip" title="Ver detalles"><i class="fas fa-eye"></i></button>'
                  . ' <a href="editar.php?id=' . (int)$r['id_insumo'] . '" class="btn btn-sm btn-warning" data-bs-toggle="tooltip" title="Editar"><i class="fas fa-edit"></i></a>'
                  . ' <button type="button" class="btn btn-sm btn-danger" onclick="abrirModalBajaInsumo(' . (int)$r['id_insumo'] . ', \'' . htmlspecialchars($r['nombre_insumo'], ENT_QUOTES) . '\')" data-bs-toggle="tooltip" title="Dar de baja"><i class="fas fa-trash"></i></button>'
                  . '</div>';
        return [
