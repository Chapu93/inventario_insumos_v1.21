    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="row g-2">
          ...
          <div class="col-md-2"><a href="<?php echo app_base_url(); ?>/pages/admin/telecom_vigilancia.php?id_localidad=<?php echo (int)$idLocalidad; ?>&id_sede=<?php echo (int)$idSede; ?>&open=add_disp" class="btn btn-sm btn-outline-primary w-100"><i class="fas fa-plus-circle me-2"></i>Agregar Dispositivo</a></div>
          ...
          <div class="col-md-2"><a href="<?php echo app_base_url(); ?>/pages/admin/sedes.php?id_localidad=<?php echo (int)$idLocalidad; ?>&id_sede=<?php echo (int)$idSede; ?>#modalSede" class="btn btn-sm btn-warning w-100"><i class="fas fa-edit me-2"></i>Editar Sede</a></div>
          <div class="col-md-2"><a href="<?php echo app_base_url(); ?>/pages/asignaciones/listar.php?localidad=<?php echo (int)$idLocalidad; ?>" class="btn btn-sm btn-info w-100"><i class="fas fa-file-alt me-2"></i>Ver Remitos</a></div>
        </div>
      </div>
    </div>
  </div>
