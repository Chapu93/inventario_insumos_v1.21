...
$rows = $db->query("SELECT d.*, s.nombre_sede, l.nombre_localidad FROM sedes_red_dispositivos d JOIN sedes s ON s.id_sede=d.id_sede JOIN localidades l ON l.id_localidad=s.id_localidad ORDER BY l.nombre_localidad, s.nombre_sede, d.tipo_dispositivo")->fetchAll();
  ...
  <div class="card-body">
    <div class="table-responsive">
      <table class="table table-striped datatable">
        <thead><tr><th>Sede</th><th>Localidad</th><th>Tipo</th><th>Marca</th><th>Modelo</th><th>Cant.</th><th>Ubicación</th><th>Estado</th><th>Acciones</th></tr></thead>
        <tbody>
          ...
          <tr>
            ...
            <td>
              <div class="btn-group" role="group">
                <button class="btn btn-sm btn-warning" onclick='editRed(<?php echo json_encode($r, JSON_HEX_TAG|JSON_HEX_APOS|JSON_HEX_AMP|JSON_HEX_QUOT); ?>)'><i class="fas fa-edit"></i></button>
                <button class="btn btn-sm btn-danger" onclick="delRed(<?php echo (int)$r['id_dispositivo']; ?>)"><i class="fas fa-trash"></i></button>
              </div>
            </td>
          </tr>
          <?php endforeach; ?>
...
<div class="modal fade" id="modalRed" tabindex="-1"><div class="modal-dialog"><div class="modal-content">
