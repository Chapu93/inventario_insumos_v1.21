...
--
-- Servidor: localhost
-- Tiempo de generación: 07-01-2026 a las 12:28:47
...
(1, 'admin', 'admin@inventario.local', '$2y$10$acRUJEKWeTLjLv5WF6M1sOa1hjCAWdFJQbqeQDytS2aLvVbFypMvS', 'Administrador', 'Sistema', 1, NULL, 1, '2025-11-06 09:08:29', '2026-01-07 08:24:11', NULL, '2026-01-07 08:24:11');
...
--
ALTER TABLE `auditoria_acciones`
  MODIFY `id_auditoria` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=430;
...
--
ALTER TABLE `insumos`
  MODIFY `id_insumo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=131;
...
--
ALTER TABLE `monitores`
  MODIFY `id_monitor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `pcs_completas`
  MODIFY `id_pc_completa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
...
--
ALTER TABLE `remitos`
  MODIFY `id_remito` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=93;

--
-- AUTO_INCREMENT de la tabla `remitos_detalle`
--
ALTER TABLE `remitos_detalle`
  MODIFY `id_detalle` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=156;
...
--
ALTER TABLE `sesiones`
  MODIFY `id_sesion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=181;
